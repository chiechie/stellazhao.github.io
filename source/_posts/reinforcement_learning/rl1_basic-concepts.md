...
# 工业界和理论界的发展
1.[DeepMind新推出的用于训练通用智能体的XLand？](http://deepmind.com/blog/article/generally-capable-agents-emerge-from-open-ended-play)

> 俞扬: 不管是Xland大规模枚举环境，还是流行的大模型，通过暴力增加数据和计算量，能实现的是现有技术性能的充分挖掘，能看到现有技术的极限，但无法突破现有原理的天花板。当我们看到当下的极限，感叹于此的时候，性能可能也就停留于此。因此个人始终认为，在没有原理性突破的情况下，不会发生质变，无法达到人们想象中的智能。对于暴力性的工作，个人更关注的不是能做到什么程度，而是如此暴力依旧做不到的事，例如StarCraft上的比赛可以看到依旧有很多远不如人类的地方，还需要新的技术来填补。
2. 强化学习这个古老的研究领域2016前在国内一直比较冷的根源就是没法用，样本利用率低。
3. 强化学习方法好用的标志--零试错：一次试错不能有，上线即能发挥效果，还要明显优于基线。offline RL是个正确的方向，但是目前的主流研究也有很多明显的弯路没法用。
...
15. https://www.zhihu.com/question/475906037/answer/2055088510
